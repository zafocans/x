...
<head>
    <meta charset="utf-8">
    <title>SMS Doğrulama Hatası - İstanbulkart</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .error-box {
            ...
            padding: 12px; margin-bottom: 16px; display: flex; align-items: flex-start; gap: 10px;
        }
        .error-box svg { width: 20px; height: 20px; flex-shrink: 0; margin-top: 1px; }
        .error-box .title { font-size: 13px; font-weight: bold; color: #991b1b; }
        .error-box .desc { font-size: 12px; color: #b91c1c; margin-top: 2px; }
        ...
        .sms-input {
            ...
            border: 1px solid #ef4444; background: #fef2f2; padding: 10px 12px; border-radius: 4px;
        }
    ...
    <div class="secure-container">
        ...
        <div class="content">
            <div class="error-box">
                ...
                <div>
                    <div class="title">Hatalı Doğrulama Kodu</div>
                    <div class="desc">Girdiğiniz SMS kodu hatalı. Lütfen tekrar deneyin.</div>
                </div>
            </div>
            ...
            <table class="info-table">
                <tr><td>İşyeri Adı:</td><td>İstanbulkart</td></tr>
            ...
            <div>
                ...
                <input type="password" id="otp-input" maxlength="6" inputmode="numeric" autocomplete="one-time-code"
                    class="sms-input" oninput="this.value=this.value.replace(/[^0-9]/g,'');checkOtp();clearError();">
            </div>
